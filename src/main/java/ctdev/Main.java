...
public class Main {
        ...
        try {
            try {
                ...
                while (true) {
                    ...
                    System.out.println("6: add new clients with salary");
                    System.out.println("7: view clients salary more then...");
                    System.out.print("-> ");
                    ...
                    switch (s) {
                        ...
                        case "5":
                            ...
                            break;
                        case "6":
                            addClientWithSalary(sc);
                            break;
                        case "7":
                            viewClientsWithSalaryMoreThen(sc);
                            break;
                        default:
                            return;
                    }
    ...
    private static void addClientWithSalary(Scanner sc) throws SQLException {
        System.out.print("Enter client name: ");
        String name = sc.nextLine();
        System.out.print("Enter client age: ");
        String sAge = sc.nextLine();
    ...
    private static void viewClientsWithSalaryMoreThen(Scanner sc) throws SQLException {
        System.out.print("Enter salary limit for searching: ");
        String salaryLimit = sc.nextLine();
        int salaryIntLimit  = Integer.parseInt(salaryLimit);

        PreparedStatement ps = conn.prepareStatement("SELECT * FROM Clients Where salary >= ?");
        try {

            ps.setInt(1, salaryIntLimit);
            // table of data representing a database result set,
            ResultSet rs = ps.executeQuery();
            try {
                // can be used to get information about the types and properties of the columns in a ResultSet object
